...
| S3_ENABLED                   | "false"               | 启用 S3 上传功能                                                                                                                                                                                                                            |
| S3_REGION                    | (not set)             | S3 区域                                                                                                                                                                                                                                      |
| S3_BUCKET                    | (not set)             | S3 存储桶名称                                                                                                                                                                                                                                |
| S3_ACCESS_KEY_ID            | (not set)             | S3 访问密钥 ID                                                                                                                                                                                                                              |
| S3_SECRET_ACCESS_KEY        | (not set)             | S3 访问密钥                                                                                                                                                                                                                                  |
| S3_ENDPOINT                  | (not set)             | S3 兼容服务的终端节点（可选，用于 MinIO 等兼容服务）                                                                                                                                                                                         |
| S3_PATH_PREFIX              | (not set)             | 上传文件的路径前缀（可选）                                                                                                                                                                                                                   |
